...
//This implementation ensures that Process objects can be stored and
//will be ordered primarily by priority and secondarily by arrivalTime when priorities are equal.
